...
public class _RentalCarStub extends org.omg.CORBA.portable.ObjectImpl implements RentalCar
{
  ...
  public void rent (Costumer cost) throws RentalCarPackage.AlreadyRented, RentalCarPackage.IsNotForRental
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:RentalCar/AlreadyRented:1.0"))
                    throw RentalCarPackage.AlreadyRentedHelper.read ($in);
                else if (_id.equals ("IDL:RentalCar/IsNotForRental:1.0"))
                    throw RentalCarPackage.IsNotForRentalHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                rent (cost        );
  ...
  public void unrent () throws RentalCarPackage.NotRented
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:RentalCar/NotRented:1.0"))
                    throw RentalCarPackage.NotRentedHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                unrent (        );
